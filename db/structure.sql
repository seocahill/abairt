...
CREATE TABLE IF NOT EXISTS "users" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "email" varchar, "name" varchar, "password_digest" varchar, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, "confirmed" boolean DEFAULT 0 NOT NULL, "token" varchar, "master_id" bigint, "grupa_id" bigint, "lat_lang" varchar, "role" integer DEFAULT 0 NOT NULL, "voice" integer DEFAULT 0 NOT NULL, "dialect" integer DEFAULT 0 NOT NULL, "password_reset_token" varchar, "password_reset_sent_at" datetime, "about" text, "address" varchar, "ability" integer DEFAULT 0 NOT NULL);
CREATE TABLE IF NOT EXISTS "rangs" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar, "user_id" integer NOT NULL, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, "url" varchar, "meeting_id" varchar, "time" datetime, "grupa_id" varchar, "start_time" datetime, "end_time" datetime, "context" integer, CONSTRAINT "fk_rails_0f519c8255"
FOREIGN KEY ("user_id")
  REFERENCES "users" ("id")
);
...
CREATE TRIGGER update_users_search AFTER UPDATE ON users BEGIN
        ...
        INSERT INTO fts_users(rowid, name) VALUES (new.id, new.name);
      END;
CREATE TABLE IF NOT EXISTS "active_storage_blobs" ("id" integer NOT NULL PRIMARY KEY, "key" varchar NOT NULL, "filename" varchar NOT NULL, "content_type" varchar DEFAULT NULL, "metadata" text DEFAULT NULL, "service_name" varchar NOT NULL, "byte_size" integer NOT NULL, "checksum" varchar DEFAULT NULL, "created_at" datetime NOT NULL);
...
CREATE TABLE IF NOT EXISTS "dictionary_entries" ("id" integer NOT NULL PRIMARY KEY, "word_or_phrase" varchar DEFAULT NULL, "translation" varchar DEFAULT NULL, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, "region_start" decimal DEFAULT NULL, "region_end" decimal DEFAULT NULL, "region_id" varchar DEFAULT NULL, "voice_recording_id" integer DEFAULT NULL, "speaker_id" integer DEFAULT NULL, "user_id" integer NOT NULL, "quality" integer DEFAULT 0 NOT NULL, CONSTRAINT "fk_rails_43cc55d212"
FOREIGN KEY ("user_id")
  REFERENCES "users" ("id")
);
