...
CREATE TABLE IF NOT EXISTS "voice_recordings" ("id" integer NOT NULL PRIMARY KEY, "title" varchar DEFAULT NULL, "description" text DEFAULT NULL, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, "peaks" json DEFAULT NULL, "user_id" integer NOT NULL, "transcription" text, "transcription_en" text, "dictionary_entries_count" integer DEFAULT 0 NOT NULL, "duration_seconds" float DEFAULT 0.0 NOT NULL, "diarization_data" jsonb, "diarization_status" varchar, "import_status" varchar, "metadata" jsonb DEFAULT '{}', "metadata_extracted_at" datetime(6), CONSTRAINT "fk_rails_91ca04707d"
FOREIGN KEY ("user_id")
  REFERENCES "users" ("id")
);
...
CREATE TABLE IF NOT EXISTS "locations" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "display_name" text, "lat" decimal(10,7) NOT NULL, "lng" decimal(10,7) NOT NULL, "county" varchar, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL);
CREATE UNIQUE INDEX "index_locations_on_coordinates" ON "locations" ("lat", "lng");
CREATE INDEX "index_locations_on_county" ON "locations" ("county");
